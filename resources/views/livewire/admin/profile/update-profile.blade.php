                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center" x-data=" {imagePreview: '{{auth()->user()->avatarUrl}}'}">
                                <input wire:model='image' type="file" x-ref="image" class="d-none" x-on:change="
                                    const reader = new FileReader();
                                    reader.onload = (event) =>{
                                        {{-- console.log(event.target.result); --}}
                                        imagePreview = event.target.result;
                                        document.getElementById('profileImage').src = `${imagePreview}`;
                                        {{-- $('#profileImage').attr('src',`${imagePreview}`) --}}
                                    };
